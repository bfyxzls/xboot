...
public class TypeServiceImpl implements TypeService {
    ...
    @Override
    public TypeDao getRepository() {
        return typeDao;
    }

    @Override
    public Page<Type> findByCondition(Type type, SearchVo searchVo, Pageable pageable) {
        ...
        return typeDao.findAll(new Specification<Type>() {
            ...
            public Predicate toPredicate(Root<Type> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {
                ...
                if (StringUtils.isNotBlank(type.getTitle())) {
                    list.add(cb.like(titleField, type.getTitle().trim()+"%"));
                }
